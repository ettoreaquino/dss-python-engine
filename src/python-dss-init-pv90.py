...
class DSS(object):
    ...
    def get_data(self):
        self.dssText.Command = "Export Powers as 'results\\pv90\\%s'"%(self.power_file_name)
        self.dssText.Command = "Export Voltages 'results\\pv90\\%s'"%(self.voltage_file_name)
...
def create_data_file(voltage, file_name):
    ...
    dat_file = open("results\\pv90\\%s"%(file_name), "w")
